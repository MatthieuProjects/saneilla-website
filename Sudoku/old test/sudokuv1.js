...
var puzzles = new Array (
  ...
  var niveaux = /*nombre de chiffre  qui vont  apparaitre en fonction du niveau (affichage sym�trique, donc faire *2)*/
  {
  ...
  /*grille= liste des chiffres, chiffres = chiffre de 1 � 9 ds le d�sordre, masque = code binaire des emplacement des chiffres, id = index du tableau, sub = tableau principale / sous tableau */
  ...
  /*changement du style au passage de la souris + selection de la case selectionn�e*/
  ...
  {
  grilleUser= new Array(81);
  if (!msg||confirm("êtes-vous sur de vouloir réinitialiser la grille ?"))
